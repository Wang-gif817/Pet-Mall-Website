    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">宠物商城网站注册</h1>
...
<style lang="scss" scoped>
    ...
    .container {
        background-image: url("https://www.2008php.com/2023_Website_appreciate/2023-08-08/20230808111628qgYkx.jpg");
        height: 100vh;
